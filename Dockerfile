...
ADD flume.conf /home/pipeline-admin/flume.conf
RUN chown pipeline-admin:pipeline-admin flume.conf

ADD check-data.py /home/pipeline-admin/check-data.py
RUN chown pipeline-admin:pipeline-admin check-data.py
